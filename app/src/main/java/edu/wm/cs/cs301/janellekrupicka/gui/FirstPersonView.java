...
import edu.wm.cs.cs301.janellekrupicka.generation.BSPLeaf;
import edu.wm.cs.cs301.janellekrupicka.generation.BSPNode;
import edu.wm.cs.cs301.janellekrupicka.generation.Floorplan;
import edu.wm.cs.cs301.janellekrupicka.generation.Wall;
...
public class FirstPersonView {
	...
	// convert hex to rgb, int rgb = 65536 * r * 256 * g + b
...
//	private Graphics2D gc; 
	/**
	 * MazePanel object to replace Graphics2D object
	 */
//	private MazePanel panel;
	...
	private void drawBackground(MazePanel mazePanel, float percentToExit) {
		...
		// previously took Graphics graphics param instead of MazePanel
