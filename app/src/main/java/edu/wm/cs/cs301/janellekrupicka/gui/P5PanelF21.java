...
public interface P5PanelF21 {
  ...
  //      final int rgbValue = calculateRGBValue(d, extensionX);
        final int rgbValue = (((distance & 7) + 2 + ((extensionX!=0)?1:0)*70)) / 8 + 80;
        //System.out.println("Initcolor rgb: " + rgbValue);
        switch (((d >> 3) ^ cc) % 6) {
        case 0:
        	return 65535*rgbValue+256*RGB_DEF+RGB_DEF;
        //	return calculateRGBInt(rgbValue, RGB_DEF, RGB_DEF);
        case 1:
        	return 65535*RGB_DEF+256*RGB_DEF_GREEN+RGB_DEF;
       //	return calculateRGBInt(RGB_DEF, RGB_DEF_GREEN, RGB_DEF);
        case 2:
        	return 65535*RGB_DEF+256*RGB_DEF+rgbValue;
       // 	return calculateRGBInt(RGB_DEF, RGB_DEF, rgbValue);
        case 3:
        	return 65535*rgbValue+256*RGB_DEF_GREEN+RGB_DEF;
        //	return calculateRGBInt(rgbValue, RGB_DEF_GREEN, RGB_DEF);
        case 4:
        	return 65535*RGB_DEF+256*RGB_DEF_GREEN+rgbValue;
        //	return calculateRGBInt(RGB_DEF, RGB_DEF_GREEN, rgbValue);
        case 5:
        	return 65535*rgbValue+256*RGB_DEF+rgbValue;
        //	return calculateRGBInt(rgbValue, RGB_DEF, rgbValue);
        default:
        	return 65535*RGB_DEF+256*RGB_DEF+RGB_DEF;
        //	return calculateRGBInt(RGB_DEF, RGB_DEF, RGB_DEF);
        }
 ...
 //   private static int calculateRGBValue(final int distance, int extensionX) {
  ...
  //  }
    /**
     * Convert red, green, blue value to rgb int
     */
  //  private static int calculateRGBInt(int r, int g, int b) {
